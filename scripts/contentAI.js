...
function EvaluateDownload()
{
    ...
    if (matchSize)
    {
        ...
        data += '<span style="font-size: x-large;">' + matchSize.innerHTML + " of qualifying text in this submission has been determined to be generated by AI.</span>";
        data += '<div style="margin: 15px; padding: 10px;" class="region reference-region">Reference overlap</div>'
        data += '<div style="margin: 15px; padding: 10px;" class="region document-region">AI structure</div>'
        data += '</div>';
    }
